...
redirect_result(){
    mkdir -p src/test/deca/extension/context/invalid/result
    test_context "$1" > src/test/deca/extension/context/invalid/result/$(basename "${1%.deca}").lis 2>&1 &
}

for i in src/test/deca/extension/context/invalid/*.deca
do
