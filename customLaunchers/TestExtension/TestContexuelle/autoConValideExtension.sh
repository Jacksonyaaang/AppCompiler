...
redirect_result(){
    mkdir -p src/test/deca/extension/context/valid/result
    test_context "$1" > src/test/deca/extension/context/valid/result/$(basename "${1%.deca}").lis 2>&1 &
}

for i in src/test/deca/extension/context/valid/*.deca
do
