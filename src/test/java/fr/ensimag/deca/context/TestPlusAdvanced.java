...
public class TestPlusAdvanced {
    ...
    public void setup() throws ContextualError {
        ...
        // when(intexpr1.getType(compiler, null, null)).thenReturn(INT);
        // when(intexpr2.getType(compiler, null, null)).thenReturn(INT);
    ...
    public void testIntFloat() throws ContextualError {
        ...
        // // check the result
        // System.out.println(t.verifyExpr(compiler, null, null).isFloat());
        // assertTrue(t.verifyExpr(compiler, null, null).isFloat());
        // // ConvFloat should have been inserted on the left side
